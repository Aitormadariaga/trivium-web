...
class PacienteController extends AbstractController
{
    ...
    public function show(int $id): Response
    {
        ...
        // if (!$paciente) throw $this->createNotFoundException('Paciente no encontrado');
        ...
        $todosPacientes = [
            1 => [
                ...
                'tiempo2'     => 15,
                'sesiones'    => [
                    ['fecha' => new \DateTime('2025-03-10 10:30'), 'dispositivo' => 'TRIVIUM-01', 'intensidad' => 8, 'tiempo' => 20],
                    ['fecha' => new \DateTime('2025-03-03 11:00'), 'dispositivo' => 'TRIVIUM-01', 'intensidad' => 7, 'tiempo' => 20],
                    ['fecha' => new \DateTime('2025-02-24 09:45'), 'dispositivo' => 'TRIVIUM-02', 'intensidad' => 6, 'tiempo' => 15],
                ],
            ],
            2 => [
                'id'          => 2,
                ...
                'tiempo2'     => null,
                'sesiones'    => [
                    ['fecha' => new \DateTime('2025-03-11 09:00'), 'dispositivo' => 'TRIVIUM-02', 'intensidad' => 10, 'tiempo' => 25],
                ],
            ],
            3 => [
                'id'          => 3,
            ...
            4 => [
                ...
                'tiempo2'     => 20,
                'sesiones'    => [
                    ['fecha' => new \DateTime('2025-03-08 10:00'), 'dispositivo' => 'TRIVIUM-01', 'intensidad' => 12, 'tiempo' => 30],
                    ['fecha' => new \DateTime('2025-03-01 10:00'), 'dispositivo' => 'TRIVIUM-01', 'intensidad' => 11, 'tiempo' => 30],
                ],
            ],
            5 => [
                'id'          => 5,
                ...
                'tiempo2'     => null,
                'sesiones'    => [
                    ['fecha' => new \DateTime('2025-03-13 12:00'), 'dispositivo' => 'TRIVIUM-03', 'intensidad' => 7, 'tiempo' => 20],
                ],
            ],
        ];

        $paciente = $todosPacientes[$id] ?? $todosPacientes[1];
        // ── FIN DATOS MOCK ─────────────────────────────────────────────
